...
function drawListToDOM(): void {
    ...
    for (let index: number = 0; index < aufgabenliste.length; index++) {
         ...
         */
        todo.innerHTML =  "<span class='check " + aufgabenliste[index].Checked + "'><i class='fas fa-check'></i></span>"
                            + aufgabenliste[index].Todo +
...
function updateCounter(): void {
    counterDOMElement.innerHTML = aufgabenliste.length + " in total ";
}
...
function addTodo(): void {
    ...
    if (inputDOMElement.value != "") {
         ...
         */
        aufgabenliste.unshift(
            {Todo: inputDOMElement.value, Checked: false }
        );
...
function toggleCheckState(index: number): void {
     ...
     */
    aufgabenliste[index].Checked = !aufgabenliste[index].Checked;
